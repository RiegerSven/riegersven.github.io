...
Absolute frequencies refer to the numbers of a particular value or category appearing in a vector (e.g., column of a data set). It may be abbreviated with $n_j$ where $n$ is the number of a specific value/category $j$.
...
::: {.callout-note appearance="simple" icon="false"}
Relative frequencies refer to the proportion of a specific value or category relative to the total number of observations. refer to the number of times a particular value or category appears in a vector (e.g., column of a data set). It may be abbreviated with $n_j$ where $n$ is the number of a specific value/category $j$.
...
#| output-location: column-fragment
with(exDat,
     table(chrVec)/length(table(chrVec))) 
...
#| output-location: column-fragment
with(exDat,
     table(chrVec)/length(table(chrVec))*100) |>
